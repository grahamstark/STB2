...
# !!! Main.UserApp is configured as an alias for Main.STBV1 and you might encounter it in some tests
using Main.STBV1, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "STBV1 tests" begin
  @includetests ARGS
end
