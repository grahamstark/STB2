...
# !!! Main.UserApp is configured as an alias for Main.ConjApp and you might encounter it in some tests
using Main.ConjApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ConjApp tests" begin
  @includetests ARGS
end
